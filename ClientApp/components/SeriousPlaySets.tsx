...
type SeriousPlaySetsComponentProps = {}
type SeriousPlaySetsComponentState = { products: Models.Lego[] | "loading" }
...
export class SeriousPlaySets extends React.Component<RouteComponentProps<{}>, SeriousPlaySetsComponentState> {
    ...
    componentWillMount() {
        get_monsterfightsproduct("Serious Play").then(products => this.setState({ ...this.state, products: products }))
